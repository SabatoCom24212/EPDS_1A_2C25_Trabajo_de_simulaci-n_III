...
\urlstyle{same}
\hypersetup{
  pdftitle={Trabajo de simulación 3},
  pdfauthor={Rinaldi, Flavio; Sabato, Ángel; Shifman, Iván; Zárate, Marcelo},
  pdflang={en},
  colorlinks=true,
  linkcolor={black},
  filecolor={Maroon},
...
\title{Trabajo de simulación 3}
\author{Rinaldi, Flavio \and Sabato, Ángel \and Shifman,
Iván \and Zárate, Marcelo}
\date{}
\begin{document}
\maketitle
...
\textsubscript{Source:
\href{https://SabatoCom24212.github.io/EPDS_1A_2C25_Trabajo_de_simulaci-n_III/C:/Users/ThinkPad/Desktop/EPDS_1A_2C25_Trabajo_de_simulación_III/EPDS_1A_2C25_Trabajo_de_simulación_III.ipynb.html}{Article
Notebook}}

\section{\texorpdfstring{Nuestra resolución: \emph{Optimización
...
\subsection{Inspección y limpieza de
...
\subsection{El perfil del top 10\%}\label{el-perfil-del-top-10}
...
\subsection{El ``salto salarial'' en la trayectoria
...
\subsection{Evolución del salario a través de los
...
\subsection{La combinación ganadora}\label{la-combinaciuxf3n-ganadora}
...
\section{\texorpdfstring{Machine Learning: \emph{Random Forest
...
\subsection{Visualización: predicciones
...
\subsection{Cálculo de la importancia de las
...
\subsection{Conclusiones del modelo de Machine
